...
const IDCardPreviewModal = ({ isOpen, onClose, children }) => {
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 print:p-0 print:bg-white print:block">
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 px-6 border-b border-gray-200 bg-white print:hidden">
            <h3 className="font-bold text-[#03045e] text-lg">ID Card Preview</h3>
          ...
          {/* Content Area */}
          <div className="p-8 md:p-12 flex items-center justify-center overflow-auto max-h-[85vh] print:max-h-none print:overflow-visible print:p-4 print:m-0">
            {children}
          </div>
        </motion.div>
